    ...
    <div className="container px-5 flex w-full flex-col">
        ...
        <div className="w-full gap-x-6 flex mb-3 h-[300px] md:h-[450px] xl:h-[600px]">
          <div className="flex-1 h-full">
            <div className="relative w-full bg-black h-full rounded-lg bg-center bg-cover shadow-2xl flex flex-col justify-end" style={{backgroundImage: "url(./thumb.jpeg)"}}>
          ...
          <div className="flex-none flex-col gap-y-6 hidden w-0 lg:flex lg:w-72 xl:w-96 h-full">
            <div className="flex-1 flex flex-col relative flex justify-end bg-center bg-cover rounded-lg shadow-md" style={{backgroundImage: "url(./thumb.jpeg)"}}>
